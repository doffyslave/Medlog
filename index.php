...
<div data-aos="zoom-in"><h3 class="font-bold">1. Record</h3><p>Input student health data.</p></div>
<div data-aos="zoom-in" data-aos-delay="150"><h3 class="font-bold">2. Track</h3><p>Monitor medicine usage.</p></div>
<div data-aos="zoom-in" data-aos-delay="300"><h3 class="font-bold">3. Analyze</h3><p>Generate reports instantly.</p></div>
</div>
</section>
