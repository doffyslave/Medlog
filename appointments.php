...
function appt_render_appointment_card(array $a, bool $isAdmin, DateTimeImmutable $nowApptRef): void
{
    ...
    ?>
    <article class="appt-v2-card <?= in_array($st, ['Cancelled', 'Rejected'], true) ? 'appt-v2-card--muted' : '' ?> <?= $readonly ? 'appt-readonly' : '' ?>"
        ...
        <div class="appt-v2-card__body">
            <div class="appt-v2-card__main">
                <?php if ($isAdmin): ?>
                    <div class="appt-v2-card__who">
                        ...
                        <strong class="appt-v2-card__name"><?= htmlspecialchars((string) ($a['name'] ?? ''), ENT_QUOTES, 'UTF-8') ?></strong>
                    </div>
                <?php endif; ?>
                <div class="appt-v2-card__when">
                    <span class="appt-v2-chip"><i class="fa-solid fa-calendar" aria-hidden="true"></i> <?= htmlspecialchars($dateFormatted, ENT_QUOTES, 'UTF-8') ?></span>
                    <span class="appt-v2-chip"><i class="fa-solid fa-clock" aria-hidden="true"></i> <?= htmlspecialchars($timeDisplay, ENT_QUOTES, 'UTF-8') ?></span>
                </div>
                <p class="appt-v2-card__reason"><?= htmlspecialchars((string) ($a['reason'] ?? ''), ENT_QUOTES, 'UTF-8') ?></p>
            ...
            <div class="appt-v2-card__side">
                <span class="appt-v2-badge <?= htmlspecialchars($statusClass, ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars($st, ENT_QUOTES, 'UTF-8') ?></span>

                <?php if (!$isAdmin && !$readonly && appt_student_can_cancel($st)): ?>
                    <form method="POST" class="appt-inline-form js-appt-confirm-form" data-appt-confirm-title="Cancel appointment" data-appt-confirm-msg="Cancel this appointment? You can book a new visit later if needed." data-appt-confirm-danger="1">
                        <input type="hidden" name="appointment_id" value="<?= (int) $a['appointment_id'] ?>">
                        <button type="submit" name="cancel_appointment" value="1" class="appt-btn appt-btn--danger appt-btn--sm">Cancel</button>
                    </form>
                        ...
                        <div class="appt-v2-actions">
                            <?php if ($st === 'Pending'): ?>
                                <form method="POST" class="appt-inline-form appt-admin-action-form">
                                    ...
                                    <button type="submit" name="admin_appointment_action" value="1" class="appt-btn appt-btn--primary appt-btn--sm">Approve</button>
                                </form>
                                <form method="POST" class="appt-inline-form appt-admin-action-form js-appt-confirm-form" data-appt-confirm-title="Reject request" data-appt-confirm-msg="Reject this appointment request? The patient will see it as rejected." data-appt-confirm-danger="1">
                                    <input type="hidden" name="appointment_id" value="<?= (int) $a['appointment_id'] ?>">
                                    <input type="hidden" name="admin_action" value="reject">
                                    <button type="submit" name="admin_appointment_action" value="1" class="appt-btn appt-btn--outline-danger appt-btn--sm">Reject</button>
                                </form>
                            <?php endif; ?>

                            <?php if (in_array($st, ['Approved', 'Rescheduled'], true)): ?>
                                <form method="POST" class="appt-inline-form appt-admin-action-form js-appt-confirm-form" data-appt-confirm-title="Mark completed" data-appt-confirm-msg="<?= htmlspecialchars($completeIsFuture ? 'This visit has not occurred yet by the schedule. Mark it completed anyway?' : 'Mark this appointment as completed?', ENT_QUOTES, 'UTF-8') ?>" data-complete-future="<?= $completeIsFuture ? '1' : '0' ?>">
                                    <input type="hidden" name="appointment_id" value="<?= (int) $a['appointment_id'] ?>">
                                    <input type="hidden" name="admin_action" value="complete">
                                    <button type="submit" name="admin_appointment_action" value="1" class="appt-btn appt-btn--primary appt-btn--sm">Complete</button>
                                </form>
                                <form method="POST" class="appt-inline-form appt-admin-action-form js-appt-confirm-form" data-appt-confirm-title="Mark missed" data-appt-confirm-msg="Mark this appointment as missed (no-show)?" data-appt-confirm-danger="1">
                                    <input type="hidden" name="appointment_id" value="<?= (int) $a['appointment_id'] ?>">
                                    <input type="hidden" name="admin_action" value="missed">
                                    <button type="submit" name="admin_appointment_action" value="1" class="appt-btn appt-btn--outline-danger appt-btn--sm">Missed</button>
                                </form>
                            <?php endif; ?>
                            ...
                            <?php if (appt_admin_can_cancel($st)): ?>
                                <form method="POST" class="appt-inline-form appt-admin-action-form js-appt-confirm-form" data-appt-confirm-title="Cancel appointment" data-appt-confirm-msg="Cancel this appointment on the schedule?" data-appt-confirm-danger="1">
                                    <input type="hidden" name="appointment_id" value="<?= (int) $a['appointment_id'] ?>">
                                    <input type="hidden" name="admin_action" value="cancel">
                                    <button type="submit" name="admin_appointment_action" value="1" class="appt-btn appt-btn--ghost appt-btn--sm">Cancel</button>
                                </form>
                            <?php endif; ?>
                        </div>
                <?php endif; ?>
    ...
    <main class="main-content">
        ...
        <section class="content appointments-page">
            ...
            <?php if ($isAdmin): ?>
                ...
                <div class="card appt-today-hero">
                    <div class="appt-today-hero__intro">
                        <div>
                            ...
                            <p class="appt-today-hero__date"><?= htmlspecialchars(date('l — F j, Y'), ENT_QUOTES, 'UTF-8') ?></p>
                        </div>
                        <div class="appt-today-hero__pulse" aria-hidden="true">
                            <span class="appt-today-hero__pulse-dot"></span>
                            Live queue · <?= (int) count($todayAppointments) ?> slot<?= count($todayAppointments) === 1 ? '' : 's' ?>
                        </div>
                    </div>
                    ...
                    <?php else: ?>
                        <ul class="appt-today-timeline">
                            <?php foreach ($todayAppointments as $ta): ?>
                                ...
                                ?>
                                <li class="appt-today-timeline__item appt-today-timeline__item--<?= htmlspecialchars(strtolower($taSt), ENT_QUOTES, 'UTF-8') ?>">
                                    <div class="appt-today-timeline__time"><?= htmlspecialchars($taTime, ENT_QUOTES, 'UTF-8') ?></div>
                                    <div class="appt-today-timeline__body">
                                        <strong><?= htmlspecialchars((string) ($ta['name'] ?? ''), ENT_QUOTES, 'UTF-8') ?></strong>
                                        <span class="appt-v2-badge <?= htmlspecialchars(appt_badge_class($taSt), ENT_QUOTES, 'UTF-8') ?>"><?= htmlspecialchars($taSt, ENT_QUOTES, 'UTF-8') ?></span>
                                        <?php if (!empty($ta['reason'])): ?>
                                            <p class="appt-today-timeline__reason"><?= htmlspecialchars((string) $ta['reason'], ENT_QUOTES, 'UTF-8') ?></p>
                                        <?php endif; ?>
                                    </div>
                                </li>
                            <?php endforeach; ?>
                ...
                <div class="appt-admin-board card" id="apptAdminBoard" data-appt-today="<?= htmlspecialchars($today, ENT_QUOTES, 'UTF-8') ?>">
                    <div class="appt-admin-board__head">
                        <div>
                            <h2 class="appt-admin-board__title">Appointment desk</h2>
                            <p class="appt-admin-board__lead"><?= (int) $activeQueueCount ?> active in workflow · use filters to narrow the list</p>
                        </div>
                    </div>
                    ...
                    <div class="appt-stat-strip" role="list">
                        ...
                        <div class="appt-stat-pill appt-stat-pill--archived" role="listitem">
                            <span class="appt-stat-pill__n"><?= (int) (($apptStatusCounts['Rejected'] ?? 0) + ($apptStatusCounts['Cancelled'] ?? 0)) ?></span>
                    ...
                    <div class="appt-toolbar">
                        <div class="appt-toolbar__search">
                            ...
                            <input type="search" id="apptFilterSearch" class="appt-toolbar__input" placeholder="Search patient, reason, date…" autocomplete="off" aria-label="Search appointments">
                        </div>
                        <div class="appt-toolbar__filters">
                            ...
                            <input type="date" id="apptFilterDate" class="appt-toolbar__date" aria-label="Filter by date">
                            <div class="appt-toolbar__pills" role="group" aria-label="Quick scope">
                                <button type="button" class="appt-pill appt-pill--active" data-appt-scope="all">All</button>
                    ...
                    foreach ($apptDeskSections as $sec):
                        $items = $sec['items'];
                        ?>
                        <section class="appt-desk-section" data-appt-section="<?= htmlspecialchars($sec['key'], ENT_QUOTES, 'UTF-8') ?>">
                            <header class="appt-desk-section__head">
                                <h3 class="appt-desk-section__title"><?= htmlspecialchars($sec['title'], ENT_QUOTES, 'UTF-8') ?></h3>
                                <span class="appt-desk-section__count"><?= count($items) ?></span>
                            </header>
                            <p class="appt-desk-section__hint"><?= htmlspecialchars($sec['hint'], ENT_QUOTES, 'UTF-8') ?></p>
                            <?php if (empty($items)): ?>
                    ...
                    <details class="appt-archive-fold">
                        <summary class="appt-archive-fold__summary">
                            ...
                            <span class="appt-archive-fold__meta">Rejected &amp; cancelled · <?= count($apptAdminBuckets['archived']) ?> record<?= count($apptAdminBuckets['archived']) === 1 ? '' : 's' ?></span>
                        </summary>
                ...
                <div class="card appt-book-shell">
                    <header class="appt-book-shell__header">
                        <div>
                            ...
                            <p class="appt-book-shell__lead">Choose when you need the nurse, then describe your visit.</p>
                        </div>
                    ...
                    <form method="POST" class="appt-book-layout" id="studentBookingForm">
                        ...
                        <div class="appt-book-panel appt-book-panel--date">
                            ...
                            <input type="date" name="appointment_date" id="bookingDate" class="appt-book-date"
                                ...
                                required>
                            <p class="appt-book-panel__hint">Slots already taken for a day are disabled automatically.</p>
                        </div>
                        <div class="appt-book-panel appt-book-panel--slots">
                            <span class="appt-book-panel__label">Select time</span>
                            <div class="appt-slot-grid appt-slot-grid--book" id="bookingSlotGrid" aria-live="polite"></div>
                            <p class="appt-book-inline-msg appt-book-inline-msg--error" id="bookingSlotError" hidden role="alert"></p>
                        ...
                        <div class="appt-book-panel appt-book-panel--full">
                            ...
                            <textarea name="reason" id="bookingReason" rows="4" class="appt-book-textarea" placeholder="Symptoms, follow-up, or purpose of visit…" required></textarea>
                            <button type="submit" name="add_appointment" value="1" class="appt-btn appt-btn--primary appt-btn--block" id="bookingSubmitBtn" disabled>
                ...
                <div class="appt-user-lists">
                    ...
                    <div class="card appt-user-card appt-user-card--history">
                        <header class="appt-user-card__head">
                            ...
                            <span class="appt-user-card__badge appt-user-card__badge--muted"><?= count($bookerHistory) ?></span>
                        </header>
...
<div class="appt-drawer appt-drawer--v2" id="adminCreateDrawer" aria-hidden="true" role="dialog" aria-modal="true" aria-labelledby="adminCreateTitle">
    <div class="appt-drawer__top">
        <button type="button" class="appt-drawer__close" id="adminCreateClose" aria-label="Close drawer">&times;</button>
        <div>
    ...
    <form method="POST" class="appt-drawer-form" id="adminCreateApptForm" autocomplete="off">
        ...
        <button type="submit" name="admin_create_appointment" value="1" class="appt-btn appt-btn--primary appt-drawer-submit">Save appointment</button>
    </form>
</div>
    ...
    <div class="appt-modal__card appt-modal__card--v2">
        ...
        <form method="POST" id="rescheduleForm" class="appt-modal__form">
            ...
            <div class="appt-modal__footer">
                ...
                <button type="submit" name="admin_reschedule" value="1" class="appt-btn appt-btn--primary">Save new schedule</button>
            </div>
        </form>
    </div>
</div>
